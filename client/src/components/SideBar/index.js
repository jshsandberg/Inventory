    ...
    <div className="sidenav">
      <ul>
          ...
          <li>
            ...
            <img src={HomePageLogo} alt="" className="logo"></img>Dashboard</Link>
          </li>
          <li>
            <Link to="/portfolio">
            <img src={InventoryLogo} alt="" className="logo"></img>Inventory</Link>
          </li>
          <li>
            <Link to="/contact" id="logout">
            <img src={LogoutLogo} alt="" className="logo"></img>Logout</Link>
          </li>
      </ul>
    </div>
  );
